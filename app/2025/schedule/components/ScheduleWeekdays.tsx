  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      {filteredData.map((day, dayIndex) => (
        <div key={`day-${dayIndex}`} className="border rounded-lg overflow-hidden bg-white shadow-sm">
          ...
          <div className="pt-2 pb-3 sm:pb-4 px-2 space-y-3 sm:space-y-4">
            {day.slots.map((timeSlot, slotIndex) => (
              <div key={`slot-${dayIndex}-${slotIndex}`} className="border-t first:border-t-0 pt-3 first:pt-0">
