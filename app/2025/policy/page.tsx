  ...
  return (
    <div className="space-y-8 max-w-3xl mx-auto">
      ...
      <section className="space-y-4">
        ...
        <p>
          非営利型一般社団法人国際コーチング連盟日本支部（以下、ICFジャパン）は、「コーチング・コンバージ2025」の運営において、参加者の個人情報を適切に取り扱い、
      ...
      <section className="space-y-4">
        ...
        <ul className="list-disc list-inside space-y-2">
          ...
          <li>参加者が事前に同意した目的に限る</li>
          <li>参加者とのネットワーキング機会の提供（例えば、希望者同士のマッチングなど）</li>
          <li>関連イベントや今後のカンファレンスの案内</li>
        </ul>
      </section>
      ...
      <section className="space-y-4">
        ...
        <ul className="list-disc list-inside space-y-2">
          <li>法令に基づく場合</li>
          <li>
            参加者が希望するサービスの提供のため、必要な範囲内で業務委託先に提供する場合（例：イベント運営事業者、システム管理者、決済処理業者など）
          </li>
        </ul>
      </section>
      ...
      <section className="space-y-4">
        ...
        <p>所在地: 〒102-0074 東京都千代田区九段南1-5-6　りそな九段ビル5F KSフロア</p>
      </section>
    </div>
  )
}
