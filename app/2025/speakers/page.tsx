...
export default function SpeakersPage() {
  const speakers: Speaker[] = [
    ...
    },
    {
      ...
      description:
        '金融機関でセールスやマーケティングの業務に従事。2013年に人事へとキャリアチェンジ後、グローバル部門の人材開発、評価昇格制度、ダイバーシティ＆インクルージョンを統括。2020年にコカ・コーラ ボトラーズジャパン入社後、人材開発部長として人材育成と採用、評価制度を担当。その後、社長補佐を経て、2023年9月より現職。',
      datetime: {
        date: '6月16日（月）',
        time: '19:00',
      },
